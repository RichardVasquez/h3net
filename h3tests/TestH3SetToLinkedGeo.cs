...
using static h3net.API.LinkedGeo;
...
namespace h3tests
{
    ...
    public class TestH3SetToLinkedGeo
    {
        ...
        public void empty()
        {
            LinkedGeoPolygon polygon = new LinkedGeoPolygon();
            List<H3Index> nullset = new List<H3Index>();
            Algos.h3SetToLinkedGeo(ref nullset, 0, ref polygon);

            Assert.True(countLinkedLoops(ref polygon) == 0, "No loops added to polygon");

            destroyLinkedPolygon(ref polygon);
        }
        ...
        public void singleHex()
        {
            ...
            Assert.True(countLinkedLoops(ref polygon) == 1, "1 loop added to polygon");
            Assert.True(countLinkedCoords(ref polygon.first) == 6,
        ...
        public void contiguous2()
        {
            ...
            Assert.True(countLinkedLoops(ref polygon) == 1, "1 loop added to polygon");
            Assert.True(countLinkedCoords(ref polygon.first) == 10,
